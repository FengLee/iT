...
<div class="container bs-docs-container">
		...
		<div class="col-md-9">
			<div class="panel panel-primary">
				...
				<form class="form-horizontal" role="form" id="command" action="${pageContext.request.contextPath}/${userId}/projects/${project.entityId}/edit" method="POST">
					<div class="form-group">
						<label for="inputFirstname" class="col-lg-2 control-label">Jmeno</label>
						<div class="col-xs-12 col-sm-6 col-md-8">
					...
					<div class="form-group">
						<div class="col-lg-offset-2 col-xs-12 col-sm-6 col-md-8">
							...
							<a href="${pageContext.request.contextPath}/${userId}/projects" class="btn btn-default">Cancel</a>
						</div>
					</div>
				</form>
			</div>
