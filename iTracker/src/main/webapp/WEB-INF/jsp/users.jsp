			...
			<div class="panel panel-primary">
				<div class="panel-heading">
		  		...
		  		<div class="col-xs-12 col-sm-6 col-md-8">
					...
					<table class="table table-hover">
						<thead>
							<tr>
								<th>Jmeno</th>
								<th>Prijmeni</th>
								<th>Blokovani prihl.</th>
								<th>Blokovani vytv.</th>																
							</tr>
						</thead>
						<tbody>
							<c:forEach var="item" items="${users}">
								...
								<tr>
									...
									<td><a href="<c:url value="/blockLog?id=${item.getEntityId() }&idl=${userId }" />" class="btn btn-primary">											
											<c:out value="${item.isBlockLogin() }"/>
										</a>
									</td>
									<td><a href="<c:url value="/blockCreate?id=${item.getEntityId() }" />" class="btn btn-primary">											
											<c:out value="${item.isBlockCreate() }"/>
										</a>
									</td>																									
								</tr>
							</c:forEach>
					...
					<div class="col-xs-12 col-sm-6 col-md-8">					
					<a href="<c:url value="/add" />" class="btn btn-primary">
